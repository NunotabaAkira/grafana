...
FROM registry.cn-hangzhou.aliyuncs.com/docker_library/alpine:3.22.2 AS alpine-base
FROM registry.cn-hangzhou.aliyuncs.com/docker_library/ubuntu:22.04 AS ubuntu-base
FROM registry.cn-hangzhou.aliyuncs.com/docker_library/golang:1.25.3-alpine AS go-builder-base
FROM registry.cn-hangzhou.aliyuncs.com/docker_library/node:22-alpine AS node-base
